...
public class SearchFragment extends Fragment {
    ...
    private void executeHttpRequestWithRetrofit(){
        ...
        this.disposable = NewsStreams
                .streamFetchSearch("search/v2/articlesearch.json?api-key=ff58457c72574ee094c10a7b22f5ebc7&q=soccer&fq=news_desk:(\"sports\")&begin_date=20181011")
    ...
    private void updateUI(SearchComposition searchComposition){
        ...
        articles.clear();
        articles.addAll(searchComposition.getResponse().getSearches());
