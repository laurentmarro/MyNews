...
public class ArticleBusinessViewHolder_ViewBinding implements Unbinder {
  private ArticleBusinessViewHolder target;

  @UiThread
  public ArticleBusinessViewHolder_ViewBinding(ArticleBusinessViewHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ArticleBusinessViewHolder target = this.target;
