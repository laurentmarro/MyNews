...
public class ArticleSearchViewHolder_ViewBinding implements Unbinder {
  private ArticleSearchViewHolder target;

  @UiThread
  public ArticleSearchViewHolder_ViewBinding(ArticleSearchViewHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ArticleSearchViewHolder target = this.target;
